...
- 13/13 讲、1,089/1,089 段完成 Codex 中文翻译；39 份英文、中文和双语 Markdown 已导出，见 [讲稿目录](TRANSCRIPTS.md)。
...
维护者于 2026-09-07 确认已获得课程视频全文翻译及公开再发布授权，处理与发布依据这一用户声明。视频 metadata 未提供 Creative Commons 标记的原始观察仍保留，不据此替原视频指定新的许可证。详见 [全文讲稿与翻译说明](TRANSLATION.md)。

公开网站提供原创预览、阅读问题、术语表、出处和时间/页码链接，以及经过核验导出的英文、中文、双语 Markdown 讲稿。中文使用保留专业英文术语、模型名、缩写和疑似 ASR 错误提示的翻译规则。原始 PDF、notebook、字幕数据及运行中间状态留在本地忽略目录；各视频完整性以当前状态记录为准。
