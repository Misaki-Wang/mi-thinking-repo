...
所有 13 个公开视频的 1,089 段已完成英文整理和 Codex 中文全文翻译，39 份 Markdown 见 [全课讲稿目录](TRANSCRIPTS.md)；23 份教学材料用于原创中文预览。格式与术语规则见 [翻译说明](TRANSLATION.md)。Week 12.2 没有可获取 slides/video，保留准备页，不能视为该讲已经完成转写。
